          ...
          <div className="center project-card ">
            <div className="center project-data">
              ...
              <p className="info-opp">
                A web-based application helping students and young professionals alike find rooms and roommates around the San
                Francisco Bay Area.
              </p>
        ...
        <Fade>
          <div className="center project-card ">
            ...
            <div className="center project-data">
              ...
              <p className="info">
                This is a photo management website that allows users to post images, search for images and view and comment on
        ...
        <Fade>
          <div className="center project-card ">
            <div className="center project-data">
              ...
              <p className="info-opp">
                This SF Hacks website I redesigned during SF Hacks 2021 and won a Web Competition for the best redesign.
              </p>
              <ul className="project-skills-opp">
        ...
        <Fade>
          <div className="center project-card ">
            <div className="center project-data">
              ...
              <p className="info-opp">
                This is a simple Netflix repositories searching app. The user can search any repositories using the search bar and
                each repository contains the information about the recent commits made to the repository.
              </p>
              <ul className="project-skills-opp">
                <li className="skill-opp">HTML</li>
                <li className="skill-opp">CSS</li>
        ...
        <Fade>
          <div className="center project-card ">
            ...
            <div className="center project-data">
              ...
              <p className="info">
                A website that shows Crypto Currency trends. This was made during the time when crypto currency reached its all
                time high value.
              </p>
              <ul className="project-skills">
                <li className="skill">HTML</li>
        ...
        <Fade>
          <div className="center project-card ">
            <div className="center project-data">
              ...
              <p className="info-opp">
                Using Google Firebase, this is a private website where registered user can only view the cards and only admins
                have the capabilities to create new cards.
              </p>
              <ul className="project-skills-opp">
                <li className="skill-opp">HTML</li>
                <li className="skill-opp">CSS</li>
        ...
        <Fade>
          <div className="center project-card ">
            ...
            <div className="center project-data">
              ...
              <p className="info">
                A website that detects faces from images taken anywhere from the internet. This was a part of a Udemy course I
                took during the summer of 2020.{" "}
              </p>
              <ul className="project-skills">
                <li className="skill">HTML</li>
                <li className="skill">CSS</li>
