...
const Projects = () => {
  const projects = [
    ...
    {
      name: "Lord Of The Rents",
      info: "This service is aimed to elevate the relationship between LandLord and Tenant. Gone are the times in which the dynamic between both parties are to be strained and without ease of connection.",
      skill: "TypeScript  HTML  CSS  Angular  Spring Boot",
      demo: "https://github.com/Burmy/Lord-Of-The-Rents/tree/main/RentalManagement-spring-boot",
      demo_type: "Backend Code",
      source: "https://github.com/Burmy/Lord-Of-The-Rents",
      img: "img-rent",
    },
    {
      name: "Pixelgram",
      ...
      skill: "TypeScript  HTML  CSS  Angular",
      demo: "https://www.figma.com/file/vVY5CsGpkpkGcRERCQiFFd/Instagram-Clone-Cognizant?type=design&node-id=0-1&mode=design",
      demo_type: "View Figma",
      source: "https://github.com/Burmy/Pixelgram",
      img: "img-pixel",
    },
    {
      name: "SF Hacks",
